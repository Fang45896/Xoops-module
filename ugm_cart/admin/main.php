<?php
/*-----------引入檔案區--------------*/
$xoopsOption['template_main'] = "ugm_cart_adm_main.tpl";
...
/*-----------秀出結果區--------------*/
#CSS
$xoTheme->addStylesheet(XOOPS_URL . "/modules/ugm_cart/css/xoops_adm.css");
$xoTheme->addStylesheet(XOOPS_URL . "/modules/ugm_cart/css/forms.css");
$xoTheme->addStylesheet(XOOPS_URL . "/modules/ugm_cart/css/module.css");
