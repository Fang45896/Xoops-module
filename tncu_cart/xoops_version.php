...
//---模組基本資訊---//
$modversion['name']        = _MI_TNCUCART_NAME;
$modversion['version']     = '1.00';
$modversion['description'] = _MI_TNCUCART_DESC;
$modversion['author']      = _MI_TNCUCART_AUTHOR;
$modversion['credits']     = _MI_TNCUCART_CREDITS;
$modversion['help']        = 'page=help';
$modversion['license']     = _MI_TNCUCART_LICENSE;
...
$modversion['tables'][1] = 'tncu_cart_files_center';
...
$i                                          = 1;
$modversion['templates'][$i]['file']        = 'tncu_cart_adm_main.tpl';
$modversion['templates'][$i]['description'] = '後台管理頁樣板';

$i++;
$modversion['templates'][$i]['file']        = 'tncu_cart_index.tpl';
