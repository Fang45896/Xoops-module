...
/*-----------秀出結果區--------------*/
#CSS
$xoTheme->addStylesheet(XOOPS_URL . "/modules/store_module/css/xoops_adm.css");
$xoTheme->addStylesheet(XOOPS_URL . "/modules/store_module/css/forms.css");
$xoTheme->addStylesheet(XOOPS_URL . "/modules/store_module/css/module.css");
...
function opForm($sn = "") {
  ...
  $row['form_title'] = $pre . _MD_STOREMODULE_PROD;
