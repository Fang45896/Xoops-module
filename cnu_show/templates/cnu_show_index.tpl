		...
		<{foreach from=$main.rows item=row}>			             
			<div class="col-sm-4">
			  <div class="item_holder">
			    <a href="<{xoAppUrl}>modules/store_module/index.php?op=opShow&sn=<{$row.sn}>">
    ...
    <div class="row">
      ...
      <div class="col-sm-8 mg-post">
        ...
        <div class="mg-post-meta">
          <span><{$row.date}></span> 
          <span>
            <a href="<{xoAppUrl modules/store_module/index.php?op=showKind&kind=}><{$row.kind}>"><{$row.kind_title}></a>
          </span>
          <span><{$row.counter}></span> 
          <{if $isAdmin}>
	          <span>
	            <a href="<{xoAppUrl modules/store_module/admin/main.php?op=opForm&sn=}><{$row.sn}>"><{$smarty.const._EDIT}></a>
	          </span>      
          <{/if}>       
        </div>
